...
#test run with:
#sudo python3 validators/validator_ZB03.py --csv_file sample_logs/sample_log_5-30-24.csv --validator_result_json sample_logs/test_json.json
...
def validate_csv(
    ...
    with open(csv_file, "r") as f:
        ...
        #find all rows where the identifier is /battery_monitor.droid_battery_telemetry
        battery_monitor_data = data[data['identifier'] == '/battery_monitor.droid_battery_telemetry']
        ...
        for index, row in data.iterrows():
            if row['identifier'] == '/battery_monitor.droid_battery_telemetry':
